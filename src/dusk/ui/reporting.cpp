...
CrashReportWindow::CrashReportWindow() : WindowSmall("modal", "modal-dialog") {
    ...
    intro->SetInnerRML(
        "Dawnlight can automatically send crash reports to the developers. Crash reports contain the "
        "following:"
    ...
    static constexpr OptionInfo kOptions[] = {
        {"Enable",
            "Send crash reports to Dawnlight developers. Reports will include the information described "
            "above.",
