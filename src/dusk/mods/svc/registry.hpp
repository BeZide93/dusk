...
extern const ServiceModule g_itemAimModule;
extern const ServiceModule g_itemSlotsModule;
extern const ServiceModule g_combatInputModule;
extern const ServiceModule g_bossFlowModule;
