...
echo.
echo Building Dusklight signed Android release APK with Dawnlight mod services
...
call platforms\android\gradlew.bat -p platforms\android :app:clean :app:packageRelease
if errorlevel 1 goto fail
